...
function exportarStockMinimoPDF() {
  const url = base_url + "admin/exportarStockMinimoPDF";
  window.open(url, "_blank");
}

function exportarStockMinimoExcel() {
  const url = base_url + "admin/exportarStockMinimoExcel";
  window.open(url, "_blank");
}
