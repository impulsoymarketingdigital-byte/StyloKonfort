...
(function ($) {
  ...
  $(function () {
    ...
    $(".loadMore").on('click', function (e) {
      ...
      if ($(".col-grid-box:hidden").length == 0) {
        $(".load-more-sec").text('No hay productos');
      }
    });
  });
  ...
  body_event.on("click", ".color1", function () {
    $("#color").attr("href", base_url + "assets/css/color1.css");
    return false;

  });
  body_event.on("click", ".color2", function () {
    $("#color").attr("href", base_url + "assets/css/color2.css");
    return false;
  });
  body_event.on("click", ".color3", function () {
    $("#color").attr("href", base_url + "assets/css/color3.css");
    return false;
  });
  body_event.on("click", ".color4", function () {
    $("#color").attr("href", base_url + "assets/css/color4.css");
    return false;
  });
  body_event.on("click", ".color5", function () {
    $("#color").attr("href", base_url + "assets/css/color5.css");
    return false;
  });
  body_event.on("click", ".color6", function () {
    $("#color").attr("href", base_url + "assets/css/color6.css");
    return false;
  });
  body_event.on("click", ".color7", function () {
    $("#color").attr("href", base_url + "assets/css/color7.css");
    return false;
  });
  body_event.on("click", ".color8", function () {
    $("#color").attr("href", base_url + "assets/css/color8.css");
    return false;
  });
  body_event.on("click", ".color9", function () {
    $("#color").attr("href", base_url + "assets/css/color9.css");
    return false;
  });
  body_event.on("click", ".color10", function () {
    $("#color").attr("href", base_url + "assets/css/color10.css");
    return false;
  });
  body_event.on("click", ".color11", function () {
    $("#color").attr("href", base_url + "assets/css/color11.css");
    return false;
  });
  body_event.on("click", ".color12", function () {
    $("#color").attr("href", base_url + "assets/css/color12.css");
    return false;
  });
  body_event.on("click", ".color13", function () {
    $("#color").attr("href", base_url + "assets/css/color13.css");
    return false;
  });
  body_event.on("click", ".color14", function () {
    $("#color").attr("href", base_url + "assets/css/color14.css");
    return false;
  });
  body_event.on("click", ".color15", function () {
    $("#color").attr("href", base_url + "assets/css/color15.css");
    return false;
  });
