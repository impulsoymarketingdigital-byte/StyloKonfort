                                ...
                                <div class="product-slick ">
                                    <?php if (count($data['imagenes']) > 0) {
                                        for ($i = 0; $i < count($data['imagenes']); $i++) { ?>
                                            <div><img src="<?php echo BASE_URL . 'assets/images/productos/' . $data['producto']['id'] . '/' . $data['imagenes'][$i]; ?>" alt="" class="img-fluid image_zoom_cls-0"></div>
                                        <?php }
                                    } else { ?>
                                        <div><img src="<?php echo BASE_URL . $data['producto']['imagen']; ?>" alt="" class="img-fluid image_zoom_cls-0"></div>
                                    <?php } ?>
                                </div>
                                <div class="row">
                                    <div class="col-12 p-0">
                                        <div class="slider-nav">
                                            <?php if (count($data['imagenes']) > 0) {
                                                for ($i = 0; $i < count($data['imagenes']); $i++) { ?>
                                                    <div><img src="<?php echo BASE_URL . 'assets/images/productos/' . $data['producto']['id'] . '/' . $data['imagenes'][$i]; ?>" alt="" class="img-fluid"></div>
                                                <?php }
                                            } else { ?>
                                                <div><img src="<?php echo BASE_URL . $data['producto']['imagen']; ?>" alt="" class="img-fluid"></div>
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-7 rtl-text">
                                <div class="product-right ">
                                    <div class="pro-group">
                                        <h2><?php echo $data['producto']['nombre']; ?></h2>
                                        <ul class="pro-price">
                                            <li><?php echo MONEDA . $data['producto']['precio']; ?></li>
                                            <li><span><?php echo MONEDA . $data['producto']['precio']; ?></span></li>
                                        </ul>
                                    ...
                                    <div id="selectSize" class="pro-group addeffect-section product-description border-product">
                                        ...
                                        <div class="size-box">
                                            ...
                                            <ul>
                                                <?php foreach ($data['sizes'] as $size) { ?>
                                                    <li data-id="<?php echo $size['id']; ?>"><a href="javascript:void(0)"><?php echo $size['nombre_corto']; ?></a></li>
                                                <?php } ?>
                                            </ul>
                                        </div>
                                        <h6 class="product-title">color</h6>
                                        <div class="color-selector inline">
                                            <ul id="content-color-detail">
                                                Selecciona size
                                            </ul>
                                        </div>
                                        ...
                                        <div class="qty-box">
                                            <div class="input-group">
                                                <button class="qty-minus" onclick="modificarStockQuick(0, 'quantitydetail')"></button>
                                                <input class="qty-adj form-control" type="number" id="quantitydetail" value="1" />
                                                <button class="qty-plus" onclick="modificarStockQuick(1, 'quantitydetail')"></button>
                                            </div>
                                        </div>
                                        <div class="product-buttons">
                                            <a href="javascript:void(0)" onclick="addCart(<?php echo $data['producto']['id']; ?>, 'quantitydetail')" class="btn cart-btn btn-normal tooltip-top" data-tippy-content="Add to cart">
                                                <i class="fa fa-shopping-cart"></i>
                                                Añadir al carrito
                                            </a>
                                            <a href="javascript:void(0)" onclick="addDeseo(<?php echo $data['producto']['id']; ?>)" class="btn btn-normal add-to-wish tooltip-top" data-tippy-content="Add to wishlist">
                                    ...
                                    <div class="pro-group">
                                        <h6 class="product-title">Opción de entrega</h6>
...
<script>
    const idSize = document.querySelector('#idSize');
    const idproducto = document.querySelector('#idproducto');
    $('.size-box ul li').on('click', function(e) {
        $(".size-box ul li").removeClass("active");
        $('#selectSize').removeClass('cartMove');
        $(this).addClass("active");
        idSize.value = $(this).attr('data-id');
        cargarColor($(this).attr('data-id'));
    });

    function cargarColor(idsize) {
        const url = base_url + 'principal/getColores/' + idproducto.value + '/' + idsize;
                ...
                if (res.colores.length > 0) {
                    ...
                    res.colores.forEach(color => {
                        html += `<label class="btn text-white" style="background-color: ${color.color};">
                            <input type="radio" name="color" onclick="verificarStock(${idsize}, ${color.id}, ${idproducto.value}, 'quantitydetail')"> ${color.nombre}
                        </label>`;
                    });
                }
