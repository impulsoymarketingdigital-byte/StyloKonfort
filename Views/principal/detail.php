            ...
            <div class="row">
                    ...
                    <div class="collection-filter-block creative-card creative-inner">
                        <div class="product-service">
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h4>oferta festival</h4>
                                    <p>nueva oferta especial festival online</p>
                                </div>
                            </div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="cart-info">
                                                                <a href="javascript:void(0)"
                                                                    ...
                                                                    class="tooltip-top" data-tippy-content="Quick View"><i
                                                                        data-feather="eye"></i></a>
                                                                <a href="<?php echo BASE_URL . 'principal/detail/' . $producto['slug']; ?>"
                                                                    class="tooltip-top" data-tippy-content="Ver Detalle"><i
                ...
                <div class="col-lg-9 col-sm-12 col-xs-12">
                    <div class="container-fluid">
                        ...
                        <div class="row ">
                            <div class="col-lg-5">
                                <div class="dtl-product-gallery-page">
                                    <!-- Slider Principal CON ZOOM INTERACTIVO -->
                                    <div class="dtl-main-slider-page" id="zoomContainerPage">
                                        <?php
                                        if (!empty($data['imagenes']) && count($data['imagenes']) > 0) {
                                            foreach ($data['imagenes'] as $index => $img) {
                                                $rutaImagen = BASE_URL . 'assets/images/productos/' . $data['producto']['id'] . '/' . $img;
                                                ?>
                                                <div class="dtl-slide-page <?php echo $index === 0 ? 'active' : ''; ?>">
                                                    <img src="<?php echo $rutaImagen; ?>"
                                                        alt="<?php echo $data['producto']['nombre']; ?>"
                                                        class="dtl-zoom-image-page"
                                                        onerror="this.src='<?php echo BASE_URL; ?>assets/images/productos/product.png'">
                                                </div>
                                                <?php
                                            }
                                        } else {
                                            $imagenPrincipal = !empty($data['producto']['imagen'])
                                                ? BASE_URL . $data['producto']['imagen']
                                                : BASE_URL . 'assets/images/productos/product.png';
                                            ?>
                                            <div class="dtl-slide-page active">
                                        ...
                                        <div class="dtl-zoom-icon-page">
                                            <i class="fa fa-search-plus"></i>
                                        </div>
                                    </div>

                                    <!-- Carrusel de Miniaturas -->
                                    <?php if (!empty($data['imagenes']) && count($data['imagenes']) > 1) { ?>
                                        <div class="dtl-thumbnails-wrapper-page">
                                            <button class="dtl-thumb-arrow-page dtl-thumb-prev-page"
                                                onclick="navegarMiniaturasPagina(-1)">
                                                <i class="fa fa-chevron-left"></i>
                                            </button>

                                            <div class="dtl-thumbnails-container-page" id="thumbnailsContainerPage">
                                                <?php foreach ($data['imagenes'] as $index => $img) {
                                                    $rutaImagen = BASE_URL . 'assets/images/productos/' . $data['producto']['id'] . '/' . $img;
                                                    ?>
                                                    <div class="dtl-thumbnail-page <?php echo $index === 0 ? 'active' : ''; ?>"
                                                        onclick="cambiarImagenPagina(<?php echo $index; ?>)">
                                                        <img src="<?php echo $rutaImagen; ?>"
                                                            alt="<?php echo $data['producto']['nombre']; ?>"
                                                            onerror="this.src='<?php echo BASE_URL; ?>assets/images/productos/product.png'">
                                                    </div>
                                            ...
                                            <button class="dtl-thumb-arrow-page dtl-thumb-next-page"
                                                onclick="navegarMiniaturasPagina(1)">
                                                <i class="fa fa-chevron-right"></i>
                                            </button>
                                        </div>
                                    <?php } else if (!empty($data['imagenes']) && count($data['imagenes']) === 1) {
                                        $imagenUnica = !empty($data['producto']['imagen'])
                                            ? BASE_URL . $data['producto']['imagen']
                                            : BASE_URL . 'assets/images/productos/product.png';
                                        ?>
                                            <div class="dtl-thumbnails-container-page">
                                                <div class="dtl-thumbnail-page active">
                                                    <img src="<?php echo $imagenUnica; ?>"
                                                        alt="<?php echo $data['producto']['nombre']; ?>"
                                                        onerror="this.src='<?php echo BASE_URL; ?>assets/images/productos/product.png'">
                                                </div>
                                            </div>
                            ...
                            <div class="col-lg-7 rtl-text">
                                <div class="product-right">
                                    ...
                                    <div class="revieu-box">
                                        <?php
                                        $uno = ($data['calificacion'] >= 1) ? 'text-warning' : 'text-muted';
                                        $dos = ($data['calificacion'] >= 2) ? 'text-warning' : 'text-muted';
                                        $tres = ($data['calificacion'] >= 3) ? 'text-warning' : 'text-muted';
                                        $cuatro = ($data['calificacion'] >= 4) ? 'text-warning' : 'text-muted';
                                        $cinco = ($data['calificacion'] == 5) ? 'text-warning' : 'text-muted';
                                        ?>
                                        <ul>
                                            <li><i class="<?php echo $uno; ?> fa fa-star"></i></li>
                                            <li><i class="<?php echo $dos; ?> fa fa-star"></i></li>
                                            <li><i class="<?php echo $tres; ?> fa fa-star"></i></li>
                            ...
                            <div class="product-box">
                                ...
                                <div class="product-detail detail-center detail-inverse">
                                    ...
                                    <div class="icon-detail">
                                        <a href="javascript:void(0)" onclick="verDetalle(<?php echo $producto['id']; ?>)"
                                            class="tooltip-top" data-tippy-content="Vista previa"> <i
                                                data-feather="eye"></i> </a>
                                        <a href="<?php echo BASE_URL . 'principal/detail/' . $producto['slug']; ?>"
                                            class="tooltip-top" data-tippy-content="Ver Detalle"><i
                                                data-feather="refresh-cw"></i></a>
