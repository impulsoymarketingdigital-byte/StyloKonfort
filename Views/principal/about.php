...
<section class="sale-banenr banner-style2  section-big-mb-space">
   <img src="<?php echo BASE_URL . 'assets/images/about.jpg'; ?>" alt="sale-banenr" class="img-fluid bg-img">
...
<section class="services2 section-pt-space mb-5">
          ...
          <?php foreach ($data['testimonios'] as $testimonio) { ?>
            <div>
              <div class="testimonial-contain">
                <div class="media">
                  <div class="testimonial-img"> <img src="<?php echo $testimonio['perfil']; ?>" class="img-fluid rounded-circle  " alt="testimonial"> </div>
