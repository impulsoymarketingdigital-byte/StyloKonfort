                    ...
                    <form class="theme-form" autocomplete="off" id="frmRegister">
                        <div class="rgt-row-2">
                            <div class="rgt-form-group">
                                ...
                                <input type="text" class="rgt-form-input" name="nombreRegistro" id="nombreRegistro"
                                    placeholder="Ingrese su nombre" required="">
                            </div>
                            <div class="rgt-form-group">
                                <label for="apellidoRegistro" class="rgt-form-label">Apellido</label>
                                <input type="text" class="rgt-form-input" name="apellidoRegistro" id="apellidoRegistro"
                        ...
                        <div class="rgt-form-group">
                            ...
                            <input type="email" class="rgt-form-input" name="correoRegistro" id="correoRegistro"
                        ...
                        <div class="rgt-row-2">
                            <div class="rgt-form-group">
                                ...
                                <input type="text" class="rgt-form-input" name="telefonoRegistro" id="telefonoRegistro"
                                    placeholder="Número de teléfono" required="">
                            </div>
                            <div class="rgt-form-group">
                                <label for="documentoRegistro" class="rgt-form-label">Documento (CI/NIT)</label>
                                <input type="text" class="rgt-form-input" name="documentoRegistro"
                                    id="documentoRegistro" placeholder="CI o NIT" required="">
                            </div>
                        </div>

                        <div class="rgt-form-group">
                            <label for="direccionRegistro" class="rgt-form-label">Dirección</label>
                            <input type="text" class="rgt-form-input" name="direccionRegistro" id="direccionRegistro"
                                placeholder="Dirección completa" required="">
                        </div>

                        <div class="rgt-row-2">
                            <div class="rgt-form-group">
                                <label for="ciudadRegistro" class="rgt-form-label">Ciudad</label>
                                <input type="text" class="rgt-form-input" name="ciudadRegistro" id="ciudadRegistro"
                                    placeholder="Ciudad" required="">
                            </div>
                            <div class="rgt-form-group">
                                <label for="departamentoRegistro" class="rgt-form-label">Departamento</label>
                                <input type="text" class="rgt-form-input" name="departamentoRegistro"
                                    id="departamentoRegistro" placeholder="Departamento" required="">
                            </div>
                        </div>

                        <div class="rgt-form-group">
                            <label for="barrioRegistro" class="rgt-form-label">Barrio</label>
                            <input type="text" class="rgt-form-input" name="barrioRegistro" id="barrioRegistro"
                                placeholder="Barrio" required="">
                        </div>
                        <div class="rgt-form-group">
                            <label for="tipoClienteRegistro" class="rgt-form-label">Tipo de cliente</label>
                            <select class="rgt-form-select" name="tipoClienteRegistro" id="tipoClienteRegistro"
                                required="">
                        ...
                        <div class="rgt-form-group">
                            ...
                            <input type="password" class="rgt-form-input" id="claveRegistro" name="claveRegistro"
                        ...
                        <div class="rgt-login-link">
                            <p>¿Ya tienes una cuenta? <a href="javascript:;" onclick="openAccount()">Inicia sesión
                                    aquí</a></p>
                        </div>
                    </form>
                </div>
