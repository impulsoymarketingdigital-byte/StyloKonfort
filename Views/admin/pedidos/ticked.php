...
<body>
    ...
    <div class="ticket-header">
        ...
        <div class="empresa-info">
            ...
            <?php endif; ?>
            <?php if (!empty($data['empresa']['correo'])): ?>
            <?php echo $data['empresa']['correo']; ?><br>
            <?php endif; ?>
        </div>
        
        <?php if (!empty($data['pedido']['id'])): ?>
        <div class="ticket-id">PEDIDO #<?php echo str_pad($data['pedido']['id'], 6, '0', STR_PAD_LEFT); ?></div>
        <?php endif; ?>
    ...
    <!-- ESTADO DEL PEDIDO -->
    <?php if (!empty($data['pedido']['estado'])): ?>
    <div class="estado-pedido">
        ESTADO: <?php echo strtoupper($data['pedido']['estado']); ?>
    </div>
    <?php endif; ?>
    ...
    <div class="cliente-info">
        <table>
            <tr>
                <td>Nombre:</td>
                <td><?php echo $data['pedido']['nombre'] . ' ' . $data['pedido']['apellido']; ?></td>
            </tr>
            <tr>
                <td>Email:</td>
                <td><?php echo $data['pedido']['email']; ?></td>
            </tr>
            <?php if (!empty($data['pedido']['direccion'])): ?>
            <tr>
                <td>Dirección:</td>
                <td><?php echo $data['pedido']['direccion']; ?></td>
            </tr>
            <?php endif; ?>
            <?php if (!empty($data['pedido']['ciudad'])): ?>
            <tr>
                <td>Ciudad:</td>
                <td><?php echo $data['pedido']['ciudad']; ?></td>
            </tr>
            <?php endif; ?>
            <tr>
                <td>Método:</td>
                <td><?php echo strtoupper($data['pedido']['metodo']); ?></td>
            </tr>
            <?php if (!empty($data['pedido']['id_transaccion'])): ?>
            <tr>
                <td>Transacción:</td>
                <td style="font-size: 6pt;"><?php echo $data['pedido']['id_transaccion']; ?></td>
            </tr>
            <?php endif; ?>
        </table>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="producto-descripcion">
                            ...
                            <small>
                                <?php 
                                if (!empty($producto['talla']) || !empty($producto['color'])) {
                                    echo $producto['talla'] . ' - ' . $producto['color'];
                                }
                                ?>
                            </small>
                        </div>
    ...
    <!-- FOOTER -->
    <div class="footer">
        <?php if (!empty($data['empresa']['mensaje'])): ?>
        <div class="mensaje">
        ...
        <div style="font-size: 6pt; margin-top: 5px; color: #999;">
            Sistema de Gestión - <?php echo date('Y'); ?>
        </div>
    </div>
</body>
</html>