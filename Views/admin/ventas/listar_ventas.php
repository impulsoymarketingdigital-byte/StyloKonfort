...
<div class="card">
    <div class="card-body">
        <h5 class="card-title text-center"><i class="fas fa-users"></i> Listado de Ventas</h5>
        <hr>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Detalle Pedido #<span id="numPedido"></span></h5>
            ...
            <div class="modal-body">
                <div class="row mb-3">
                    ...
                    <div class="col-6">
                        ...
                        <p><strong>Método:</strong> <span id="detMetodo"></span></p>
                    </div>
                </div>
...
<script src="<?php echo BASE_URL . 'assets/admin/js/modulos/listar_ventas.js'; ?>"></script>