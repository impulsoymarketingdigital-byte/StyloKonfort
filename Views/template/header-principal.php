...
<body class="bg-light ">
  ...
  <header id="stickyheader">
        ...
        <div class="row">
          <div class="col-4">
            <div class="contact-block">
              <div class="sm-nav-block">
                <ul class="nav-slide">
                  <li>
                    <div class="nav-sm-back"> Menú <i class="fa fa-angle-right ps-2"></i> </div>
                  </li>
                  <?php foreach ($this->base->getCategorias() as $categoria) { ?>
                    <li><a href="<?php echo $categoria['slug']; ?>"><?php echo $categoria['categoria']; ?></a></li>
                  <?php } ?>
                </ul>
              </div>
                ...
                <ul>
                  <li>
                    <div class="contact-item-main">
                      <svg enable-background="new 0 0 511.999 511.999" viewBox="0 0 511.999 511.999" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <path d="m171.966 210.754c17.546-17.546 17.546-46.094 0-63.64l-61.707-61.707c-9.439-9.44-22.524-14.223-35.887-13.123-13.108 1.079-24.964 7.761-32.527 18.331-1.57 2.194-3.086 4.42-4.571 6.664l124.083 124.083z" />
                          <path d="m426.592 401.74-61.707-61.707c-17.544-17.544-46.094-17.546-63.64 0l-10.609 10.609 124.088 124.088c2.244-1.485 4.466-3.007 6.659-4.576 10.57-7.563 17.252-19.419 18.332-32.527 1.101-13.365-3.683-26.446-13.123-35.887z" />
                          <path d="m248.213 374.426c-12.021 0-23.32-4.681-31.82-13.18l-65.64-65.64c-8.499-8.499-13.181-19.8-13.181-31.82 0-6.828 1.515-13.422 4.377-19.404l-120.002-120.003c-16.88 35.443-24.35 75.152-21.268 115.01 4.153 53.71 27.315 104.164 65.221 142.069l64.642 64.641c37.904 37.905 88.359 61.067 142.069 65.221 5.869.454 11.733.679 17.583.679 33.875 0 67.202-7.552 97.426-21.946l-120.004-120.004c-5.981 2.863-12.575 4.377-19.403 4.377z" />
                          ...
                          <path d="m301.998 209.986s.001.005.001.014c0 8.284 6.716 15 15 15s15-6.716 15-15c0-16.542-13.458-30-30-30-8.284 0-15 6.709-15 14.993s6.715 14.993 14.999 14.993z" />
                          ...
                          <path d="m301.999 60c-8.284 0-15 6.716-15 15s6.716 15 15 15c66.168 0 120 53.832 120 120 0 8.284 6.716 15 15 15s15-6.716 15-15c0-82.71-67.29-150-150-150z" />
                        </g>
                      </svg>
                  ...
                  <?php } else { ?>
                    <li class="mobile-user">
                      <a href="<?php echo BASE_URL . 'clientes'; ?>" class="align-items-center">
                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                          <g>
                            <g>
                              <path d="M256,0c-74.439,0-135,60.561-135,135s60.561,135,135,135s135-60.561,135-135S330.439,0,256,0z M256,240
          ...
          <div class="col-4">
            <div class="logo-block">
              <a href="<?php echo BASE_URL; ?>"> <img src="<?php echo BASE_URL; ?>assets/images/logo.png" alt="logo" class="img-fluid" width="50">
              </a>
            </div>
          </div>
          <div class="col-4">
            <div class="icon-block">
              <ul>
                <li onclick="openAccount()" class="mobile-user onhover-dropdown">
                ...
                <li class="mobile-wishlist item-count" onclick="openWishlist()">
                  <a href="javascript:void(0)">
                    ...
                    <div class="item-count-contain" id="btnCantidadDeseo"> 0 </div>
                  </a>
                </li>
                ...
                <li class="mobile-cart item-count" onclick="openCart()">
                  <a href="javascript:void(0)">
                    ...
                    <div class="item-count-contain" id="btnCantidadCarrito"> 0 </div>
                  </a>
                </li>
              </ul>
    ...
    <div class="category-header-4">
            ...
            <div class="navbar-menu">
                ...
                <div class="nav-block">
                  <div class="nav-left">
                    <nav class="navbar" data-bs-toggle="collapse" data-bs-target="#navbarToggleExternalContent">
                      ...
                      <h5 class="mb-0  text-white title-font">Compra por categoría</h5>
                    </nav>
                    <div class="collapse <?php echo ($data['perfil'] == 'no') ? 'show' : ''; ?> nav-desk" id="navbarToggleExternalContent">
                      <ul class="nav-cat title-font">
                        <?php foreach ($this->base->getCategorias() as $categoria) { ?>
                          <li><a href="<?php echo BASE_URL . 'principal/categorias/' . $categoria['slug']; ?>"><?php echo $categoria['categoria']; ?></a></li>
                        <?php } ?>
                      </ul>
                    </div>
                  </div>
              ...
              <div class="menu-block">
                <ul id="main-menu" class="sm pixelstrap sm-horizontal">
                  <li>
                    <div class="mobile-back text-right">Atras<i class="fa fa-angle-right ps-2" aria-hidden="true"></i>
                    </div>
                  </li>
                  <!--HOME-->
                  <li>
                    <a class="light-menu-item" href="<?php echo BASE_URL; ?>">Inicio</a>
                  </li>
                  <!--HOME-END-->
                  <!--SHOP-->
                  <li>
                    <a class="light-menu-item" href="<?php echo BASE_URL . 'principal/shop'; ?>">Tienda</a>
                  </li>
                  <!--SHOP-END-->
                  <!--product-meu start-->
                  <li class="mega">
                    <a class="light-menu-item" href="<?php echo BASE_URL . 'principal/about'; ?>">Servicios
                    </a>
                  </li>
                  <!--product-meu end-->
                  ...
                  <!--mega-meu start-->
                  <li class="mega">
                    <a class="light-menu-item" href="<?php echo BASE_URL . 'principal/contactos'; ?>">Contactos</a>
                  </li>
                  <!--mega-meu end-->
                </ul>
              </div>
              <div class="input-block">
                <div class="input-box">
                  <form class="big-deal-form position-relative">
                    <div class="input-group ">
                      <span class="search"><i class="fa fa-search"></i></span>
                      <input type="text" class="form-control" id="inputSearch" autocomplete="off" placeholder="¿Que estas buscando?">
                    </div>
                    <!-- Hover added -->
                    <div class="list-group position-absolute" id="resultBusqueda" style="z-index: 99999;">
                    </div>
                  </form>
                  ...
                  <ul>
                    ...
                    <li class="mobile-wishlist item-count" onclick="openWishlist()">
                      <a href="javascript:void(0)">
                        ...
                        <div class="item-count-contain item-whtie" id="btnCantidadDeseo1"> 0 </div>
                      </a>
                    </li>
                    ...
                    <li class="mobile-cart item-count" onclick="openCart()">
                      <a href="javascript:void(0)">
                        ...
                        <div class="item-count-contain item-whtie" id="btnCantidadCarrito1"> 0 </div>
                      </a>
                    </li>
                  </ul>
      ...
      <div class="searchbar-input position-relative">
        <div class="input-group">
          ...
          <input type="text" class="form-control" id="inputSearch1" autocomplete="off" placeholder="¿Que estas buscando?">
        ...
        <div class="list-group position-absolute" id="resultBusqueda1" style="z-index: 99999;">
        </div>
      </div>
    </div>
  </header>
